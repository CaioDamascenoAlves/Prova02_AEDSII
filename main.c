    ...
    while (op != -1) {
        switch (op) {
            case (1):
                ...
                nFunc = 2000;
                cria_base_dados_funcionarios(arq, arqIndicePrimario, arqIndicePrimarioNaoOrdenado, nFunc);
                crioubase = 1;
                break;
            case (2):
            ...
            case (4):
                ...
                nomes = cria("p1.dat", cria("p2.dat", cria("p3.dat", cria("p4.dat", cria("p5.dat", cria("p6.dat",
                                                                                                        cria("p7.dat",
                                                                                                             cria("p8.dat",
                                                                                                                  cria("p9.dat",
                                                                                                                       cria("p10.dat",
